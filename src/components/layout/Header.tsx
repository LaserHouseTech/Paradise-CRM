  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5">
        ...
        {/* Supabase Database Status Pill & Sync Button */}
        <div className="hidden md:flex items-center gap-1">
          <button
            ...
            className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg border text-xs font-medium transition group ${
          ...
          <button
            ...
            title="Recarregar dados do Supabase agora"
            className="p-1.5 rounded-lg border border-white/10 bg-white/[0.04] hover:bg-white/[0.08] text-neutral-400 hover:text-white transition"
          >
            <RefreshCw className={`w-3.5 h-3.5 ${supabaseSyncState === 'syncing' ? 'animate-spin text-blue-400' : ''}`} />
          </button>
        </div>
